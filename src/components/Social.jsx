      ...
      <div className="main">
        <div className="up">
          <button className="card1">
            <svg className="whatsapp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height={30} width={30}>
          ...
          <button className="card2">
            <svg xmlns="http://www.w3.org/2000/svg" className="linkedin" height="1.6em" viewBox="0 0 448 512">
