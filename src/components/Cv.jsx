...
const CV = () => {
  return (
    ...
    <div className="cv-header">
      <span className="cv-title">Andrew</span>
      <p className="cv-subtitle">Front-end</p>
    </div>
    <button className="cv-download-btn">
      Download CV
      <svg className="cv-download-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
    ...
    <svg className="cv-decorative-svg-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <svg className="cv-decorative-svg-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
